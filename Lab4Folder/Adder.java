public class Adder {
    ...
    public Adder(String name, int increment, int counter, int placeholder) {
        this.name = name;
        this.counter = counter;
        this.increment = increment;
    }
    ...
    public int add(int num2, int num1, int placeholder) {
        return num1 + num2;
    }
    ...
    public double add(double num1, double num2, double placeholder) {
        return num1 + num2;
    }
    ...
    public double add(int x, int y, double z, double placeholder) {
        return x + y + z;
    }
